...
3. A time series plot of the Phillies win percentage from 1901-2015 is shown in the plot below, along with ACF and PACF plots. The time series plot doesn't indicate a trend, and the ACF plot doesn't indicate much  seasonality, so no differencing seems necessary.
...
This is my preferred model since it has fewer terms, a lower aic value and all of the diagnostic plots look the same or better. The only diagnostic plot that could be improved is the normal Q-Q plot, which currently shows some skewness, especially in the lower tail.
