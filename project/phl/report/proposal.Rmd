...
The time series plot of historical monthly enplanements has a cyclical pattern evident of seasonality and heterogeneous variance across time. The employment time series also shows seasonality, but the variance is relatively stable. The earnings data shows a trend, some seasonality and heterogeneous variance.
